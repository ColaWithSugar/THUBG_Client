...
public class MenuController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        this._helpButton = GameObject.Find("Canvas/HelpButton").GetComponent<Button>();
        ...
        this._closeButton = GameObject.Find("Canvas/RecordViewer/CloseButton").GetComponent<Button>();
        ...
        {
            // Prior: find folders
            List<string> LevelFolders = Directory.GetDirectories($"{this._projectPath}/worlds").ToList();
            // Next: find files
            string[] allLevels = Directory.GetFiles($"{this._projectPath}/worlds", "*.nclevel", SearchOption.AllDirectories);
            // Compare them
            ...
            this._levels = LevelFolders.ToArray();
